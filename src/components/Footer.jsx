                ...
                <div className="mx-auto w-full p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                <h2 className="mb-6 font-extrabold uppercase">Services</h2>
                                <ul className="text-body">
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline ">Advertising</a>
                                    </li>
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline">Content marketing</a>
                                    </li>
                                    <li className="mb-4">
                            ...
                            <div>
                                <h2 className="mb-6 font-extrabold uppercase">Legal</h2>
                                <ul className="text-body font-medium">
                                    <li className="mb-4">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">agency.ai™</a>. All Rights Reserved.
                        </span>
